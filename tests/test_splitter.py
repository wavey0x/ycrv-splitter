...
def test_allocation_scenarios(dev, splitter, crvusd_whale, ylockers_ms, gov, crvusd, 
    ...
    discretionary_gauges = [splitter.discretionaryGauges(i) for i in range(num_discretionary)]
    for g in voted_gauges:
